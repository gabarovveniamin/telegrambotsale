...
class ScraperService:
    ...
    async def fetch_kaspi_discounts(self) -> list:
        kaspi_categories = [
            {"code": "Smartphones", "label": "kaspi_Smartphones"},
            {"code": "Notebooks", "label": "kaspi_Notebooks"},
            {"code": "Tablets", "label": "kaspi_Tablets"},
            {"code": "Headphones", "label": "kaspi_Headphones"},
            {"code": "tv_audio", "label": "kaspi_tv_audio"},
            {"code": "Refrigerators", "label": "kaspi_Refrigerators"},
            {"code": "Vacuum Cleaners", "label": "kaspi_Vacuum Cleaners"},
            {"code": "Monitors", "label": "kaspi_Monitors"},
            {"code": "Computers", "label": "kaspi_Computers"},
            {"code": "Desktop Computers", "label": "kaspi_Desktop Computers"},
            {"code": "Game consoles", "label": "kaspi_Game consoles"},
            {"code": "home equipment", "label": "kaspi_home equipment"},
            {"code": "Furniture", "label": "kaspi_Furniture"},
            {"code": "beauty care", "label": "kaspi_beauty care"},
            {"code": "Car Goods", "label": "kaspi_Car Goods"},
            {"code": "sports and outdoors", "label": "kaspi_sports and outdoors"},
            {"code": "child goods", "label": "kaspi_child goods"},
            {"code": "pharmacy", "label": "kaspi_pharmacy"},
            {"code": "construction and repair", "label": "kaspi_construction and repair"},
            {"code": "fashion", "label": "kaspi_fashion"},
            {"code": "shoes", "label": "kaspi_shoes"},
            {"code": "fashion accessories", "label": "kaspi_fashion accessories"},
            {"code": "jewelry and bijouterie", "label": "kaspi_jewelry and bijouterie"},
            {"code": "home", "label": "kaspi_home"},
            {"code": "pet goods", "label": "kaspi_pet goods"},
            {"code": "leisure", "label": "kaspi_leisure"},
        ]
        all_items = []
